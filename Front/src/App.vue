...
<v-container>
            ...
            <Product name="Echiquier acajou et sycomore 44 cm avec notations"/>
  ...
  >
    ...
    >
      ...
      <v-col
        ...
        cols="12"
      >
        {{ new Date().getFullYear() }} — <strong>Copyright © 2019 MyChess Ltd - Paris
</strong>
      </v-col>
    </v-row>
    </v-footer>
